                    ...
                    <div class="d-flex">
                        ...
                        <c:choose>
                            <c:when test="${user == null}">
                                <a class="btn btn-outline-primary text-decoration-none" href="./auth/login.jsp" type="button">Đăng nhập</a>
                                <a class="btn btn-primary text-decoration-none ms-3" href="./auth/register.jsp" type="button">Đăng ký</a> 
                            </c:when>    
                            <c:otherwise>
